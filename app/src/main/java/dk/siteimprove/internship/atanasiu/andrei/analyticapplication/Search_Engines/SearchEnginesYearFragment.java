...
public class SearchEnginesYearFragment extends Fragment implements View.OnClickListener
{
    ...
    public SearchEnginesYearFragment() {  }    // Required empty public constructor
    ...
    public void onAttach(Context context)
    {
        ...
        if (context instanceof SearchEnginesMonthFragment.OnFragmentInteractionListener)
        {
