...
public class TrafficSourcesMainFragment extends Fragment
{
    ...
    public TrafficSourcesMainFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("Tab1").setIndicator("Today"), TrafficSourcesFragment.class, arg1);

        Bundle arg2 = new Bundle();
        arg2.putInt("Arg for Frag2", 2);
        mTabHost.addTab(mTabHost.newTabSpec("Tab2").setIndicator("Week"), TrafficSourcesWeekFragment.class, arg2);

        Bundle arg3 = new Bundle();
        arg3.putInt("Arg for Frag3", 3);
        mTabHost.addTab(mTabHost.newTabSpec("Tab3").setIndicator("Month"), TrafficSourcesMonthFragment.class, arg3);

        Bundle arg4 = new Bundle();
        arg4.putInt("Arg for Frag4", 4);
        mTabHost.addTab(mTabHost.newTabSpec("Tab4").setIndicator("Year"), TrafficSourcesYearFragment.class, arg4);
